...
export default function DraftState({state}: Props): ReactElement {
    ...
    return <div className={'gridTimeline'}>
        ...
        <DraftEvent team={'radiant'} event={'pick'} heroId={state.radiant.pick2_id} heroClass={state.radiant.pick2_class}/>
        <DraftEvent team={'dire'} event={'pick'} heroId={state.dire.pick2_id} heroClass={state.dire.pick2_class}/>
        ...
        <DraftEvent team={'radiant'} event={'ban'} heroId={state.radiant.ban6_id} heroClass={state.radiant.ban6_class}/>
        <DraftEvent team={'dire'} event={'ban'} heroId={state.dire.ban6_id} heroClass={state.dire.ban6_class}/>
        <DraftEvent team={'radiant'} event={'pick'} heroId={state.radiant.pick5_id} heroClass={state.radiant.pick5_class}/>
        <DraftEvent team={'dire'} event={'pick'} heroId={state.dire.pick5_id} heroClass={state.dire.pick5_class}/>
